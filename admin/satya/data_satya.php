<div class="card card-info">
	<div class="card-header"style="background-color : #455A64;">
		<h3 class="card-title">
			<i class="fa fa-table"></i> Data Riwayat Satya Lencana</h3>
	</div>
	<br>
	...
	<div class="card-body">
		...
		<div style="display: flex; justify-content: left;">
			...
			<?php } ?>
			<a href="?page=add-satya&nik=<?php echo $_GET['nik']; ?>&nama=<?php echo $_GET['nama']; ?>"
			...
			<table id="example1" class="table table-bordered table-striped">
              ...
              $no = 1;
			  //perlu di perhatikan
			  $sql = $koneksi->query("SELECT * from riwayat_satya_lencana a 
            ...
            ?>
					...
					<tr>
						...
						<div>
								<a href="?page=view-satya&kode=<?php echo $data['id_satya_lencana']; ?>" title="Detail"
								class="btn btn-info btn-sm">
								<i class="fa fa-eye"></i>
							</a>
						</a>
						<a href="?page=edit-satya&kode=<?php echo $data['id_satya_lencana']; ?>&nik=<?php echo $_GET['nik']; ?>&nama=<?php echo $_GET['nama']; ?>" title="Ubah" class="btn btn-success btn-sm">
							<i class="fa fa-edit"></i>
						</a>

						<?php if($_SESSION["ses_level"] == 'Administrator') { ?>
						<a href="?page=del-satya&kode=<?php echo $data['id_satya_lencana']; ?>&nik=<?php echo $_GET['nik']; ?>&nama=<?php echo $_GET['nama']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')"
