<div class="card card-info">
	<div class="card-header"style="background-color : #455A64;">
		<h3 class="card-title">
			<i class="fa fa-table"></i> Data Riwayat Jabatan</h3>
	</div>
	<br>
	...
	<div class="card-body">
		...
		<div style="display: flex; justify-content: left;">
			...
			<?php } ?>
			<a href="?page=add-jabatan&nik=<?php echo $_GET['nik']; ?>&nama=<?php echo $_GET['nama']; ?>"
			...
			<table id="example1" class="table table-bordered table-striped">
              ...
              $no = 1;
			  //perlu di perhatikan
			  $sql = $koneksi->query("SELECT * from riwayat_jabatan a 
            ...
            ?>
					...
					<tr>
						...
						<a href="?page=edit-jabatan&kode=<?php echo $data['id_jabatan']; ?>&nik=<?php echo $_GET['nik']; ?>&nama=<?php echo $_GET['nama']; ?>" title="Ubah" class="btn btn-success btn-sm">
							<i class="fa fa-edit"></i>
						</a>
						<?php if($_SESSION["ses_level"] == 'Administrator') { ?>
						<a href="?page=del-jabatan&kode=<?php echo $data['id_jabatan']; ?>&nik=<?php echo $_GET['nik']; ?>&nama=<?php echo $_GET['nama']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')"
