<div class="card card-info">
	<div class="card-header"style="background-color : #455A64;">
		<h3 class="card-title">
			<i class="fa fa-table"></i> Data Riwayat Penghargaan</h3>
	</div>
	<br>
	...
	<div class="card-body">
		...
		<div style="display: flex; justify-content: left;">
			...
			<?php } ?>
			<a href="?page=add-penghargaan&nik=<?php echo $_GET['nik']; ?>&nama=<?php echo $_GET['nama']; ?>"
			...
			<table id="example1" class="table table-bordered table-striped">
              ...
              $no = 1;
			  //perlu di perhatikan
			  $sql = $koneksi->query("SELECT * from riwayat_penghargaan a 
            ...
            ?>
					...
					<tr>
						...
						<div>
								<a href="?page=view-penghargaan&kode=<?php echo $data['id_penghargaan']; ?>" title="Detail"
								class="btn btn-info btn-sm">
								<i class="fa fa-eye"></i>
							</a>
						</a>
						<a href="?page=edit-penghargaan&kode=<?php echo $data['id_penghargaan']; ?>&nik=<?php echo $_GET['nik']; ?>&nama=<?php echo $_GET['nama']; ?>" title="Ubah" class="btn btn-success btn-sm">
							<i class="fa fa-edit"></i>
						</a>

						<?php if($_SESSION["ses_level"] == 'Administrator') { ?>
						<a href="?page=del-penghargaan&kode=<?php echo $data['id_penghargaan']; ?>&nik=<?php echo $_GET['nik']; ?>&nama=<?php echo $_GET['nama']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')"
