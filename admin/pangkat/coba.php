<div class="card card-info">
	<div class="card-header" style="background-color : #455A64;">
		<h3 class="card-title">
			<i class="fa fa-table"></i> Data Riwayat Pangkat
		</h3>
	</div>
	<br>
	<center>
	...
	<div class="card-body">
		<div style="display: flex; justify-content: left;">
			...
			<?php } ?>
			<a href="?page=add-golongan&nik=<?php echo $_GET['nik']; ?>&nama=<?php echo $_GET['nama']; ?>"
					...
					<tr>
						...
						<td style="display:flex;flex-direction:column">
							...
							<div>
								...
								<a href="?page=edit-pangkat&kode=<?php echo $data['id_pangkat']; ?>&nik=<?php echo $_GET['nik']; ?>&nama=<?php echo $_GET['nama']; ?>"
									title="Ubah" class="btn btn-success btn-sm">
									<i class="fa fa-edit"></i>
								</a>

								<?php if ($_SESSION["ses_level"] == 'Administrator') { ?>
									<a href="?page=del-pangkat&kode=<?php echo $data['id_pangkat']; ?>&nik=<?php echo $_GET['nik']; ?>&nama=<?php echo $_GET['nama']; ?>"
